...
LABEL summary="$SUMMARY" \
      ...
      name="rhscl/postgresql-12-rhel7" \
...
RUN yum install -y yum-utils gettext && \
    ...
    INSTALL_PKGS="rsync tar gettext bind-utils nss_wrapper rh-postgresql12 rh-postgresql12-postgresql-contrib rh-postgresql12-pgaudit rh-postgresql10-postgresql-server" && \
